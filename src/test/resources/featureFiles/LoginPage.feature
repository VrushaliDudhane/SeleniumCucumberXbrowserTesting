...
Then the first option "Continue with Google" gets displayed

Scenario: To verify Continue With email option has been displayed
Then the second option "Continue with email" gets displayed

Scenario: To verify that user can login with valid credentials
Then the first option "Continue with Google" gets displayed
And the second option "Continue with email" gets displayed
